    ...
    <div class="container mx-auto my-5">
        <div class="flex flex-wrap">
            <div class="flex-1 flex-grow px-4 overflow-hidden">
                <div class="bg-white dark:bg-gray-900 border-b dark:border-gray-800">
                ...
                <div class="bg-white dark:bg-gray-900">
                    @foreach($posts as $item)
                        <div class="p-6 relative border-b border-opacity-5 dark:border-gray-50">
                            <h4 class="text-xl font-medium"><a class="dark:text-gray-400 hover:text-red-500 hover:underline" href="/post/{{ $item->id }}" title="{{ $item->post_title }}">{{ $item->post_title }}</a></h4>
